      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            from <span className="purple"> Minnesota, United States.</span>
            ...
            <span className="purple">Bachelors Degree</span> in Computer Science with <span className="purple">GPA 3.85</span>.
            <br />
            <br />      
